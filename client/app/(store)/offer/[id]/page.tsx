        ...
        {(offer.bogoBuyProducts?.length > 0 || offer.bogoGetProducts?.length > 0) && (
          <section>
            ...
            <div className="flex flex-col md:flex-row justify-center items-stretch gap-8">
              {/* Buy These */}
              <div className={`bg-gray-50 p-6 rounded-xl border border-gray-100 w-full ${offer.bogoBuyProducts?.length === 1 ? 'md:flex-[1] md:max-w-[320px]' : 'md:flex-[2] md:max-w-[608px]'}`}>
                ...
                <div className={offer.bogoBuyProducts?.length === 1 ? "block" : "grid grid-cols-2 gap-4"}>
              ...
              {/* Get These Free */}
              <div className={`bg-gray-50 p-6 rounded-xl border border-gray-100 w-full ${offer.bogoGetProducts?.length === 1 ? 'md:flex-[1] md:max-w-[320px]' : 'md:flex-[2] md:max-w-[608px]'}`}>
                ...
                <div className={offer.bogoGetProducts?.length === 1 ? "block" : "grid grid-cols-2 gap-4"}>
