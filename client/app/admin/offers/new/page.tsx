...
export default function NewOfferPage() {
  ...
  const submitHandler = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error(error);
      const message = error.response?.data?.message || error.message || 'Failed to create offer';
      toast.error(message);
      setLoading(false);
    }
  };
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 pb-10">
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-serif font-medium tracking-wide text-gray-900 uppercase">Create Offer</h1>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 gap-6">
            <div>
              ...
              <input
                ...
                placeholder="e.g., Summer Cosmetics Sale"
            ...
            <div className="flex items-center gap-3 mt-6">
              ...
              />
              <label htmlFor="isActive" className="text-sm font-bold text-gray-700">Set as Active immediately</label>
            </div>
            ...
            {/* Standard Products section is ALWAYS shown now unless we want to hide it. We'll show it if not purely BOGO/BUNDLE or if STANDARD is checked */}
